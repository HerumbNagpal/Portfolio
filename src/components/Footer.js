...
export const Footer = () => {
  return (
    <div className='footer'>
      <div className="imgs">
      <a href="https://github.com/HerumbNagpal" target="_blank" rel="noopener noreferrer" style={{ color: 'inherit', textDecoration: 'inherit' }}  > <img className='imge' src={Github} alt="ig" />  </a>
